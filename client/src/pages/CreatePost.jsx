...
const CreatePost = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    if(form.prompt && form.photo){
      ...
      try{
        const response = await fetch('https://dalle-vsy9.onrender.com/api/v1/post',
        {
          method: 'POST',
          headers: {
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-w text-[#666e75] text-[16px] max-w[500px]">
          Create imaginative and visually stunning images through DALL-E, a
          GPT-3 powered AI and share them with the community.
        </p>
      </div>
          ...
          >
            {form.photo ? (
              ...
              <img
                src={preview}
                alt="preview"
                className="w-9/12 h-9/12 object-contain opaccity-40"
              />
            )}
            {generatingImg && (
              <div
